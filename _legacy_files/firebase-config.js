...
import { getAuth, signInAnonymously, onAuthStateChanged, getIdToken } from 'https://www.gstatic.com/firebasejs/9.22.0/firebase-auth.js';
import { getFirestore, doc, setDoc, getDoc, updateDoc, increment, query, where, getDocs, orderBy, limit, collection } from 'https://www.gstatic.com/firebasejs/9.22.0/firebase-firestore.js';

// Firebase configuration - replace with your actual config
// IMPORTANT: These values should be replaced with real Firebase project configuration
const firebaseConfig = {
  apiKey: "AIzaSyAiJ5ZKDCrYLKGQ3dB4xx_y-A07xRmzR5k",
  authDomain: "uploop-2b769.firebaseapp.com",
  projectId: "uploop-2b769",
  storageBucket: "uploop-2b769.firebasestorage.app",
  ...
  messagingSenderId: "536883426028",
  appId: "1:536883426028:web:7488628cfbf158b28eebc9",
  measurementId: "G-KFWLFRTCGY"
};
...
export async function initFirebase() {
  try {
    ...
    console.warn('Firebase authentication failed, continuing without Firebase:', error.message);
